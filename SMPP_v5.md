...
- [1 Introduction](#1-introduction)
  ...
  - [1.4 SMPP Overview](#14-smpp-overview)
    - [1.4.1 Protocol Versions](#141-protocol-versions)
    - [1.4.2 Supported Cellular Technologies](#142-supported-cellular-technologies)
    - [1.4.3 Typical Applications of SMPP](#143-typical-applications-of-smpp)
    - [1.4.4 SMPP Sessions](#144-smpp-sessions)
    - [1.4.5 Protocol Operations and PDUs](#145-protocol-operations-and-pdus)
      - [1.4.5.1 Session Management Operations](#1451-session-management-operations)
      - [1.4.5.2 Message Submission Operations](#1452-message-submission-operations)
      - [1.4.5.3 Message Delivery Operations](#1453-message-delivery-operations)
      - [1.4.5.4 Message Broadcast Operations](#1454-message-broadcast-operations)
      - [1.4.5.5 Anciliary Submission Operations](#1455-anciliary-submission-operations)
      - [1.4.5.6 Anciliary Broadcast Operations](#1456-anciliary-broadcast-operations)
- [2 SMPP Sessions](#2-smpp-sessions)
  - [2.1 Application Layer Communication](#21-application-layer-communication)
  - [2.2 Establishing a SMPP Session](#22-establishing-a-smpp-session)
  - [2.3 Session States](#23-session-states)
    - [2.3.1 Open](#231-open)
    - [2.3.2 Bound_TX](#232-bound_tx)
    - [2.3.3 Bound_RX](#233-bound_rx)
    - [2.3.4 Bound_TRX](#234-bound_trx)
    - [2.3.5 Unbound](#235-unbound)
    - [2.3.6 Closed](#236-closed)
    - [2.3.7 Outbound](#237-outbound)
  - [2.4 Operation Matrix](#24-operation-matrix)
  - [2.5 Sample Sessions](#25-sample-sessions)
    - [2.5.1 Example Transmitter Session](#251-example-transmitter-session)
    - [2.5.2 Example Receiver Session](#252-example-receiver-session)
    - [2.5.3 Example Transceiver Session](#253-example-transceiver-session)
    - [2.5.4 Example Transmitter Session (Cell Broadcast Entity)](#254-example-transmitter-session-cell-broadcast-entity)
    - [2.5.5 Example Outbind Session](#255-example-outbind-session)
  - [2.6 PDU Sequencing](#26-pdu-sequencing)
    - [2.6.1 The PDU Sequence Number](#261-the-pdu-sequence-number)
    - [2.6.2 Why use Monotonically Increasing Sequence numbers?](#262-why-use-monotonically-increasing-sequence-numbers)
    - [2.6.3 Sequence Numbers Across Sessions](#263-sequence-numbers-across-sessions)
    - [2.6.4 Synchronous Vs. Asynchronous](#264-synchronous-vs-asynchronous)
    - [2.6.5 Why Asynchronous?](#265-why-asynchronous)
  - [2.7 Session Timers](#27-session-timers)
  - [2.8 Error Handling](#28-error-handling)
    - [2.8.1 Handling Connection Failure](#281-handling-connection-failure)
    - [2.8.2 Operation Failure](#282-operation-failure)
  - [2.9 Flow Control and Congestion Avoidance](#29-flow-control-and-congestion-avoidance)
  - [2.10 Session Security and Encryption](#210-session-security-and-encryption)
    - [2.10.1 Leased Lines](#2101-leased-lines)
    - [2.10.2 Secure Transport Layer](#2102-secure-transport-layer)
    - [2.10.3 Secure VPN](#2103-secure-vpn)
    - [2.10.4 Secure Tunnel](#2104-secure-tunnel)
  - [2.11 Forward and Backward Compatibility](#211-forward-and-backward-compatibility)
    - [2.11.1 Forward Compatibility](#2111-forward-compatibility)
    - [2.11.2 Backward Compatibility](#2112-backward-compatibility)
- [3 SMPP Parameter and PDU Format](#3-smpp-parameter-and-pdu-format)
  - [3.1 Parameter Type Definitions](#31-parameter-type-definitions)
    - [3.1.1 NULL Settings](#311-null-settings)
    - [3.1.2 SMPP Parameter Field Size Notation](#312-smpp-parameter-field-size-notation)
  - [3.2 General PDU Format](#32-general-pdu-format)
    - [3.2.1 PDU Format](#321-pdu-format)
      - [3.2.1.1 Command_length](#3211-command_length)
      - [3.2.1.2 Command_id](#3212-command_id)
      - [3.2.1.3 Command_status](#3213-command_status)
      - [3.2.1.4 Sequence_number](#3214-sequence_number)
      - [3.2.1.5 Standard Parameters](#3215-standard-parameters)
      - [3.2.1.6 TLV Parameters](#3216-tlv-parameters)
    - [3.2.2 A sample PDU](#322-a-sample-pdu)
- [4 SMPP PDU Definitions](#4-smpp-pdu-definitions)
  - [4.1 Session Management Operations](#41-session-management-operations)
    - [4.1.1 Bind Operation](#411-bind-operation)
      - [4.1.1.1 bind_transmitter Syntax](#4111-bind_transmitter-syntax)
      - [4.1.1.2 bind_transmitter_resp Syntax](#4112-bind_transmitter_resp-syntax)
      - [4.1.1.3 bind_receiver Syntax](#4113-bind_receiver-syntax)
      - [4.1.1.4 bind_receiver_resp Syntax](#4114-bind_receiver_resp-syntax)
      - [4.1.1.5 bind_transceiver Syntax](#4115-bind_transceiver-syntax)
      - [4.1.1.6 bind_transceiver_resp Syntax](#4116-bind_transceiver_resp-syntax)
      - [4.1.1.7 outbind Syntax](#4117-outbind-syntax)
      - [4.1.1.8 unbind Syntax](#4118-unbind-syntax)
      - [4.1.1.9 unbind_resp Syntax](#4119-unbind_resp-syntax)
    - [4.1.2 Enquire Link Operation](#412-enquire-link-operation)
      - [4.1.2.1 enquire_link Syntax](#4121-enquire_link-syntax)
      - [4.1.2.2 enquire_link_resp Syntax](#4122-enquire_link_resp-syntax)
    - [4.1.3 Alert Notification Operation](#413-alert-notification-operation)
      - [4.1.3.1 alert_notification Syntax](#4131-alert_notification-syntax)
    - [4.1.4 Generic NACK Operation](#414-generic-nack-operation)
      - [4.1.4.1 generic_nack Syntax](#4141-generic_nack-syntax)
  - [4.2 Message Submission Operations](#42-message-submission-operations)
    - [4.2.1 submit_sm Operation](#421-submit_sm-operation)
      - [4.2.1.1 submit_sm Syntax](#4211-submit_sm-syntax)
      - [4.2.1.2 submit_sm_resp Syntax](#4212-submit_sm_resp-syntax)
    - [4.2.2 data_sm Operation](#422-data_sm-operation)
      - [4.2.2.1 data_sm Syntax](#4221-data_sm-syntax)
      - [4.2.2.2 data_sm_resp Syntax](#4222-data_sm_resp-syntax)
    - [4.2.3 submit_multi Operation](#423-submit_multi-operation)
      - [4.2.3.1 submit_multi Syntax](#4231-submit_multi-syntax)
      - [4.2.3.2 submit_multi_resp Syntax](#4232-submit_multi_resp-syntax)
    - [4.2.4 Message Submission Request TLVs](#424-message-submission-request-tlvs)
    - [4.2.5 Message Submission Response TLVs](#425-message-submission-response-tlvs)
    - [4.2.6 Source and Destination Addressing](#426-source-and-destination-addressing)
      - [4.2.6.1 TON](#4261-ton)
        - [4.2.6.1.1 International and National Format](#42611-international-and-national-format)
        - [4.2.6.1.2 Alphanumeric Format](#42612-alphanumeric-format)
      - [4.2.6.2 NPI](#4262-npi)
      - [4.2.6.3 ESME Addresses](#4263-esme-addresses)
    - [4.2.7 Message Replace operation in submit_sm](#427-message-replace-operation-in-submit_sm)
    - [4.2.8 Message Length](#428-message-length)
    - [4.2.9 Message Types](#429-message-types)
      - [4.2.9.1 Registered](#4291-registered)
      - [4.2.9.2 Scheduled](#4292-scheduled)
      - [4.2.9.3 Pre-defined](#4293-pre-defined)
    - [4.2.10 Message Modes](#4210-message-modes)
      - [4.2.10.1 Default Message Mode](#42101-default-message-mode)
      - [4.2.10.2 Store and Forward Message Mode](#42102-store-and-forward-message-mode)
      - [4.2.10.3 Datagram Message Mode](#42103-datagram-message-mode)
      - [4.2.10.4 Transaction Message Mode](#42104-transaction-message-mode)
  - [4.3 Message Delivery Operations](#43-message-delivery-operations)
    - [4.3.1 deliver_sm Operation](#431-deliver_sm-operation)
      - [4.3.1.1 deliver_sm Syntax](#4311-deliver_sm-syntax)
      - [4.3.1.2 deliver_sm_resp Syntax](#4312-deliver_sm_resp-syntax)
    - [4.3.2 data_sm Operation](#432-data_sm-operation)
    - [4.3.3 Message Delivery Request TLVs](#433-message-delivery-request-tlvs)
    - [4.3.4 Message Delivery Response TLVs](#434-message-delivery-response-tlvs)
    - [4.3.5 Delivery Message Types](#435-delivery-message-types)
      - [4.3.5.1 MC Delivery Receipt](#4351-mc-delivery-receipt)
      - [4.3.5.2 Intermediate Notification](#4352-intermediate-notification)
      - [4.3.5.3 SME Delivery Acknowledgement](#4353-sme-delivery-acknowledgement)
      - [4.3.5.4 SME Manual/User Acknowledgement](#4354-sme-manualuser-acknowledgement)
      - [4.3.5.5 Conversation Abort](#4355-conversation-abort)
  - [4.4 Message Broadcast Operations](#44-message-broadcast-operations)
    - [4.4.1 broadcast_sm Operation](#441-broadcast_sm-operation)
      - [4.4.1.1 broadcast_sm Syntax](#4411-broadcast_sm-syntax)
      - [4.4.1.2 broadcast_sm_resp Syntax](#4412-broadcast_sm_resp-syntax)
    - [4.4.2 Broadcast Request Optional TLVs](#442-broadcast-request-optional-tlvs)
    - [4.4.3 Broadcast Response Optional TLVs](#443-broadcast-response-optional-tlvs)
    - [4.4.4 Message Replacement with broadcast_sm](#444-message-replacement-with-broadcast_sm)
  - [4.5 Ancillary Submission Operations](#45-ancillary-submission-operations)
    - [4.5.1 cancel_sm Operation](#451-cancel_sm-operation)
      - [4.5.1.1 cancel_sm Syntax](#4511-cancel_sm-syntax)
      - [4.5.1.2 cancel_sm_resp Syntax](#4512-cancel_sm_resp-syntax)
    - [4.5.2 query_sm Operation](#452-query_sm-operation)
      - [4.5.2.1 query_sm Syntax](#4521-query_sm-syntax)
      - [4.5.2.2 query_sm_resp Syntax](#4522-query_sm_resp-syntax)
    - [4.5.3 replace_sm Operation](#453-replace_sm-operation)
      - [4.5.3.1 replace_sm Syntax](#4531-replace_sm-syntax)
      - [4.5.3.2 replace_sm_resp Syntax](#4532-replace_sm_resp-syntax)
      - [4.5.3.3 Message Replacement TLVs](#4533-message-replacement-tlvs)
  - [4.6 Ancillary Broadcast Operations](#46-ancillary-broadcast-operations)
    - [4.6.1 query_broadcast_sm Operation](#461-query_broadcast_sm-operation)
      - [4.6.1.1 query_broadcast_sm Syntax](#4611-query_broadcast_sm-syntax)
      - [4.6.1.2 Query Broadcast Request Optional TLVs](#4612-query-broadcast-request-optional-tlvs)
      - [4.6.1.3 query_broadcast_sm_resp Syntax](#4613-query_broadcast_sm_resp-syntax)
      - [4.6.1.4 Query Broadcast Response Optional TLVs](#4614-query-broadcast-response-optional-tlvs)
    - [4.6.2 cancel_broadcast_sm Operation](#462-cancel_broadcast_sm-operation)
      - [4.6.2.1 cancel_broadcast_sm Syntax](#4621-cancel_broadcast_sm-syntax)
      - [4.6.2.2 Cancel Broadcast Optional TLVs](#4622-cancel-broadcast-optional-tlvs)
      - [4.6.2.3 cancel_broadcast_sm_resp Syntax](#4623-cancel_broadcast_sm_resp-syntax)
  - [4.7 PDU Field Definitions](#47-pdu-field-definitions)
    - [4.7.1 addr_ton, source_addr_ton, dest_addr_ton, esme_addr_ton](#471-addr_ton-source_addr_ton-dest_addr_ton-esme_addr_ton)
    - [4.7.2 addr_npi, source_addr_npi, dest_addr_npi, esme_addr_npi](#472-addr_npi-source_addr_npi-dest_addr_npi-esme_addr_npi)
    - [4.7.3 address_range](#473-address_range)
      - [4.7.3.1 UNIX Regular Expressions](#4731-unix-regular-expressions)
    - [4.7.4 command_length](#474-command_length)
    - [4.7.5 command_id](#475-command_id)
    - [4.7.6 command_status, error_status_code](#476-command_status-error_status_code)
    - [4.7.7 data_coding](#477-data_coding)
    - [4.7.8 destination_addr](#478-destination_addr)
    - [4.7.9 dest_flag](#479-dest_flag)
    - [4.7.10 dl_name](#4710-dl_name)
    - [4.7.11 esme_addr](#4711-esme_addr)
    - [4.7.12 esm_class](#4712-esm_class)
    - [4.7.13 interface_version](#4713-interface_version)
    - [4.7.14 message_id](#4714-message_id)
    - [4.7.15 message_state](#4715-message_state)
    - [4.7.16 no_unsuccess](#4716-no_unsuccess)
    - [4.7.17 number_of_dests](#4717-number_of_dests)
    - [4.7.18 password](#4718-password)
    - [4.7.19 priority_flag](#4719-priority_flag)
    - [4.7.20 protocol_id](#4720-protocol_id)
    - [4.7.21 registered_delivery](#4721-registered_delivery)
    - [4.7.22 replace_if_present_flag](#4722-replace_if_present_flag)
    - [4.7.23 scheduled_delivery_time, validity_period, final_date](#4723-scheduled_delivery_time-validity_period-final_date)
      - [4.7.23.1 scheduled_delivery_time](#47231-scheduled_delivery_time)
      - [4.7.23.2 validity_period](#47232-validity_period)
      - [4.7.23.3 final_date](#47233-final_date)
      - [4.7.23.4 Absolute Time Format](#47234-absolute-time-format)
      - [4.7.23.5 Relative Time Format](#47235-relative-time-format)
    - [4.7.24 sequence_number](#4724-sequence_number)
    - [4.7.25 service_type](#4725-service_type)
    - [4.7.26 short_message](#4726-short_message)
    - [4.7.27 sm_default_msg_id](#4727-sm_default_msg_id)
    - [4.7.28 sm_length](#4728-sm_length)
    - [4.7.29 source_addr](#4729-source_addr)
    - [4.7.30 system_id](#4730-system_id)
    - [4.7.31 system_type](#4731-system_type)
  - [4.8 PDU TLV Definitions](#48-pdu-tlv-definitions)
    - [4.8.1 TLV Tag](#481-tlv-tag)
    - [4.8.2 TLV Length](#482-tlv-length)
    - [4.8.3 TLV Value](#483-tlv-value)
    - [4.8.4 TLV Definitions](#484-tlv-definitions)
      - [4.8.4.1 additional_status_info_text](#4841-additional_status_info_text)
      - [4.8.4.2 alert_on_message_delivery](#4842-alert_on_message_delivery)
      - [4.8.4.3 billing_identification](#4843-billing_identification)
      - [4.8.4.4 broadcast_area_identifier, failed_broadcast_area_identifier](#4844-broadcast_area_identifier-failed_broadcast_area_identifier)
        - [4.8.4.4.1 Broadcast Area Format types](#48441-broadcast-area-format-types)
      - [4.8.4.5 broadcast_area_success](#4845-broadcast_area_success)
      - [4.8.4.6 broadcast_content_type_info](#4846-broadcast_content_type_info)
      - [4.8.4.7 broadcast_channel_indicator](#4847-broadcast_channel_indicator)
      - [4.8.4.8 broadcast_content_type](#4848-broadcast_content_type)
      - [4.8.4.9 broadcast_end_time](#4849-broadcast_end_time)
      - [4.8.4.10 broadcast_error_status](#48410-broadcast_error_status)
      - [4.8.4.11 broadcast _frequency_interval](#48411-broadcast-_frequency_interval)
      - [4.8.4.12 broadcast_message_class](#48412-broadcast_message_class)
      - [4.8.4.13 broadcast_rep_num](#48413-broadcast_rep_num)
      - [4.8.4.14 broadcast_service_group](#48414-broadcast_service_group)
      - [4.8.4.15 callback_num](#48415-callback_num)
      - [4.8.4.16 callback_num_atag](#48416-callback_num_atag)
      - [4.8.4.17 callback_num_pres_ind](#48417-callback_num_pres_ind)
      - [4.8.4.18 congestion_state](#48418-congestion_state)
      - [4.8.4.19 delivery_failure_reason](#48419-delivery_failure_reason)
      - [4.8.4.20 dest_addr_np_country](#48420-dest_addr_np_country)
      - [4.8.4.21 dest_addr_np_information](#48421-dest_addr_np_information)
      - [4.8.4.22 dest_addr_np_resolution](#48422-dest_addr_np_resolution)
      - [4.8.4.23 dest_addr_subunit](#48423-dest_addr_subunit)
      - [4.8.4.24 dest_bearer_type](#48424-dest_bearer_type)
      - [4.8.4.25 dest_network_id](#48425-dest_network_id)
      - [4.8.4.26 dest_network_type](#48426-dest_network_type)
      - [4.8.4.27 dest_node_id](#48427-dest_node_id)
      - [4.8.4.28 dest_subaddress](#48428-dest_subaddress)
      - [4.8.4.29 dest_telematics_id](#48429-dest_telematics_id)
      - [4.8.4.30 dest_port](#48430-dest_port)
      - [4.8.4.31 display_time](#48431-display_time)
      - [4.8.4.32 dpf_result](#48432-dpf_result)
      - [4.8.4.33 its_reply_type](#48433-its_reply_type)
      - [4.8.4.34 its_session_info](#48434-its_session_info)
      - [4.8.4.35 language_indicator](#48435-language_indicator)
      - [4.8.4.36 message_payload](#48436-message_payload)
      - [4.8.4.37 message_state](#48437-message_state)
      - [4.8.4.38 more_messages_to_send](#48438-more_messages_to_send)
      - [4.8.4.39 ms_availability_status](#48439-ms_availability_status)
      - [4.8.4.40 ms_msg_wait_facilities](#48440-ms_msg_wait_facilities)
      - [4.8.4.41 ms_validity](#48441-ms_validity)
      - [4.8.4.42 network_error_code](#48442-network_error_code)
      - [4.8.4.43 number_of_messages](#48443-number_of_messages)
      - [4.8.4.44 payload_type](#48444-payload_type)
      - [4.8.4.45 privacy_indicator](#48445-privacy_indicator)
      - [4.8.4.46 qos_time_to_live](#48446-qos_time_to_live)
      - [4.8.4.47 receipted_message_id](#48447-receipted_message_id)
      - [4.8.4.48 sar_msg_ref_num](#48448-sar_msg_ref_num)
      - [4.8.4.49 sar_segment_seqnum](#48449-sar_segment_seqnum)
      - [4.8.4.50 sar_total_segments](#48450-sar_total_segments)
      - [4.8.4.51 sc_interface_version](#48451-sc_interface_version)
      - [4.8.4.52 set_dpf](#48452-set_dpf)
      - [4.8.4.53 sms_signal](#48453-sms_signal)
      - [4.8.4.54 source_addr_subunit](#48454-source_addr_subunit)
      - [4.8.4.55 source_bearer_type](#48455-source_bearer_type)
      - [4.8.4.56 source_network_id](#48456-source_network_id)
      - [4.8.4.57 source_network_type](#48457-source_network_type)
      - [4.8.4.58 source_node_id](#48458-source_node_id)
      - [4.8.4.59 source_port](#48459-source_port)
      - [4.8.4.60 source_subaddress](#48460-source_subaddress)
      - [4.8.4.61 source_telematics_id](#48461-source_telematics_id)
      - [4.8.4.62 user_message_reference](#48462-user_message_reference)
      - [4.8.4.63 user_response_code](#48463-user_response_code)
      - [4.8.4.64 ussd_service_op](#48464-ussd_service_op)
